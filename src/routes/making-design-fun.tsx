    ...
    <ArticleLayout>
        ...
        <ArticleContent>
          ...
          <ContextBox
            summary={
              <>
                <p>I work best when I'm making things I genuinely enjoy, things I'd make even without payment. That's when the best work happens.</p>
              </>
            }
          />
          ...
          <div className="bg-neutral-50 border-l-4 border-neutral-300 p-6 my-8 rounded">
            <p className="m-0">The question that drives it all: Why should making things be hard? Why should there be so much friction between an idea and its realization?</p>
          </div>
          <p>
            ...
            tabs={[
              {
                id: "birthday",
                title: "Birthday card",
                subtitle: "A moment of delight",
                description: "A small moment of delight. A reminder that design doesn't need to be grand—sometimes the joy is in the details, the unexpected animation, the gesture that makes you smile.",
                src: "/articles/birthday-card.mp4",
                alt: "Birthday card animation",
                type: "video",
                children: null,
              },
              {
                ...
                subtitle: "Embodied interaction",
                description: "Exploring how gestures can make technology feel natural and embodied. When interaction becomes intuitive, the tool disappears. Only the delight remains.",
                src: "/articles/hand-gesture.mp4",
                alt: "Hand gesture interaction demo",
                type: "video",
                children: null,
              },
              {
                ...
                description: "Beyond screens. Exploring how voice can become an interface—natural, conversational, human. What does it feel like to talk to a tool that listens?",
                src: "/articles/voice.mp4",
                alt: "Voice interaction demo",
                type: "video",
                children: null,
              },
              {
                ...
                src: "/articles/palo-alto.mp4",
                alt: "Palo Alto location-based interaction",
                type: "video",
                children: null,
              }
            ]}
          ...
          <div className="bg-neutral-50 border-l-4 border-neutral-300 p-6 my-8 rounded">
            <p className="m-0">The core belief: If I can remove friction, amplify joy, and make creation feel less like work and more like haha, then I've done my job.</p>
          </div>
